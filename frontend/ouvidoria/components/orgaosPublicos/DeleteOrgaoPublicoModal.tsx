...
type DeleteOrgaoPublicoModalProps = {
...
const DeleteOrgaoPublicoModal = ({ orgao, isSaving, onCancel, onConfirm }: DeleteOrgaoPublicoModalProps) => {
	if (!orgao) {
		return null;
	}
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4">
			<div className="w-full max-w-md space-y-6 rounded-3xl border border-neutral-200 bg-white p-8 text-center shadow-2xl">
				...
				<h2 className="text-lg font-semibold text-neutral-900">Excluir órgão público?</h2>
				<p className="text-sm text-neutral-600">
					Essa ação não pode ser desfeita. O órgão "{orgao.nome}" será removido do sistema.
				</p>
...
export default DeleteOrgaoPublicoModal;
